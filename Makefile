...
DEPENDENCIES := $(CORE_OBJECTS:.o=.d) $(UDS_OBJECTS:.o=.d) $(THREADED_UDS_OBJECTS:.o=.d) $(CLIENT_OBJECT:.o=.d) $(UNIT_OBJECTS:.o=.d) $(INTEGRATION_OBJECT:.o=.d)
...
all: wirecommand wirecommand-uds wirecommand-uds-threaded
...
integration-test: wirecommand-uds wirecommand-uds-threaded $(INTEGRATION_RUNNER)
...
clean:
	rm -rf -- $(BUILD_DIR)
	rm -f -- *.gcov
	rm -f -- wirecommand wirecommand-uds wirecommand-uds-threaded
